...
export const Main = ({products, vendors, invoices, product, vendor, invoice, invoiceTableData, handleMasterStateUpdate, handleInput, handleSubmit, setActiveItem, inventoryNeeds, currentDate, submitOrders}) => (
  <main>
    <Switch>
      ...
      <Route path='/invoices' render={props => <Invoices invoices={invoices} invoice={invoice} invoiceTableData={invoiceTableData} vendors={vendors} products={products} handleMasterStateUpdate={handleMasterStateUpdate} handleInput={handleInput} handleSubmit={handleSubmit} setActiveItem={setActiveItem} {...props} />} />
